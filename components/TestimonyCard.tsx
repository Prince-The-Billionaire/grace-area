...
const TestimonyCard = () => {
  return (
    <div>
        <div className='hover:border-2 hover:border-lime-500 w-[40rem] md:w-[28rem] max-md:w-[16rem] max-md:p-4 mt-10 p-8 md:p-4 rounded-2xl flex flex-col gap-5 text-wrap bg-black/10'>
            <p className='font-bold md:text-xl max-md:text-lg text-2xl'>Title: Fast Child Delivery</p>
            <p className='text-xl  max-md:text-sm md:text-base font-sans'> Testimony: I want to thank God firstly for the salvation of my soul, 
            ...
            <div className='flex flex-row items-center max-md:gap-4 gap-10'>
